...
export const ProjectDetailsView: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto">
            {isOwner && (
              <>
                <button
                  ...
                  className="cursor-pointer flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg text-xs font-semibold text-slate-600 border border-slate-200 bg-white hover:bg-slate-50 focus:outline-none transition-colors"
                >
                ...
                <button
                  ...
                  className="cursor-pointer flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg text-xs font-semibold text-red-650 border border-slate-200 bg-white hover:bg-red-50 focus:outline-none transition-colors"
                >
            ...
            <button
              ...
              className="cursor-pointer w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-500 transition-all duration-200 active:scale-[0.98] shadow-lg shadow-indigo-550/10"
            >
      ...
      <div className="bg-slate-150/50 border bg-white border-slate-200 rounded-2xl p-6">
        <h3 className="text-xs font-bold text-slate-700    pb-3 mb-2 flex items-center gap-2">
          Project Members
        </h3>
